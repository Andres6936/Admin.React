                ...
                <ul className={"nav justify-content-end"}>
                    ...
                    <li className="nav-item">
                        <button className="nav-link border-0" type={"button"} data-bs-toggle={"dropdown"}
                            ...
                            <span className={"mt-2 p-1 translate-middle badge rounded-pill text-white bg-danger"}
                    ...
                    <li className="nav-item">
                        <button className="nav-link border-0" type={"button"} style={{backgroundColor: "inherit"}}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
